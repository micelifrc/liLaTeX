...
\providecommand{\NumPages}{} % può essere posto a 0 se non vogliamo numerare le pagine oppure a 1 se vogliamo numerarle
...
\ifnum\getpagerefnumber{LastPage}>1\relax \OverwriteFlagIfEmpty{\NumPages}{1} \else \OverwriteFlagIfEmpty{\NumPages}{0} \fi
