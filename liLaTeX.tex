...
\newcommand{\qqsep}[1]{\qquad #1 \qquad} % separatore fra dei \qquad
\newcommand{\qsr}[2]{\qsep{\stackrel{#2}{#1}}} % separatore fra dei \stackrel
\newcommand{\qqsr}[2]{\qqsep{\stackrel{#2}{#1}}} % separatore fra dei \stackrel
\newcommand{\qe}{\qsep{\text{e}}}
\newcommand{\qqe}{\qqsep{\text{e}}}
\newcommand{\qlr}{\qsep{\Longrightarrow}}
\newcommand{\qqlr}{\qqsep{\Longrightarrow}}
