...
\newcommand{\griglia}[5][]{
	...
	\setkeyvalueifempty{s}{\kv{step}};
	\setkeyvalueifempty{step x}{\kv{s}};
	\setkeyvalueifempty{step y}{\kv{s}};
	\setkeyvalueifempty{s x}{\kv{step x}};
	\setkeyvalueifempty{s y}{\kv{step y}};
...
\newcommand{\cartamillimetratapagina}[1][]{\cartamillimetrata[#1]{0}{21}{0}{29.7};}
