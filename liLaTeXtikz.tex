...
\newcommand{\propinv}[4][]{
	\extractcoordpaircolon{\propinvfromx}{\propinvtox}{#2};
	\extractcoordpaircolonbis{\propinvfromy}{\propinvtoy}{#3};
...
% \extractcoordpair[separatore]{<- \x}{<- \y}{P} estrae le coordinate di P e le scrive in \x e \y. Gli unici separatori supportati al momento sono , e :
\newcommand{\extractcoordpair}[4][,]{
	\ifx,#1 \extractcoordpaircomma{#2}{#3}{#4}
	\else
		\ifx:#1 \extractcoordpaircolon{#2}{#3}{#4} \fi
	\fi
}

% \extractcoordpaircomma{<- \x}{<-  \y}{P} estrae le due coordinate di P e le scrive in \x e in \y. P deve essere scritto esplicitamente come coordinata
\newcommand{\extractcoordpaircomma}[3]{
	\def\extractcoordpaircommax{}
	\def\extractcoordpaircommay{}
	\extractcoordpaircommaIterFist#3,
	\def#1{\extractcoordpaircommax}
	\def#2{\extractcoordpaircommay}
}
\newcommand{\extractcoordpaircommaIterFist}[1]{
	\ifx,#1 
		\expandafter\extractcoordpaircommaIterSecond
	\else 
		\estendistr\extractcoordpaircommax{#1}
		\expandafter\extractcoordpaircommaIterFist
	\fi
}
\newcommand{\extractcoordpaircommaIterSecond}[1]{
	\ifx,#1 \else
		\estendistr\extractcoordpaircommay{#1}
		\expandafter\extractcoordpaircommaIterSecond
	\fi
}

% \extractcoordpaircolon{<- \a}{<-  \r}{P} estrae le due coordinate polari di P e le scrive in \a e in \r. P deve essere scritto esplicitamente come coordinata. Funziona anche per un range
\newcommand{\extractcoordpaircolon}[3]{
	\def\extractcoordpaircolona{}
	\def\extractcoordpaircolonr{}
	\extractcoordpaircolonIterFist#3:
	\def#1{\extractcoordpaircolona}
	\def#2{\extractcoordpaircolonr}
}
\newcommand{\extractcoordpaircolonIterFist}[1]{
	\ifx:#1 
		\expandafter\extractcoordpaircolonIterSecond
	\else 
		\estendistr\extractcoordpaircolona{#1}
		\expandafter\extractcoordpaircolonIterFist
	\fi
}
\newcommand{\extractcoordpaircolonIterSecond}[1]{
	\ifx:#1 \else
		\estendistr\extractcoordpaircolonr{#1}
		\expandafter\extractcoordpaircolonIterSecond
	\fi
}

% \extractcoordpaircolonbis è identico a \extractcoordpaircolon (non si può usare due volte \extractcoordpaircolon, se no la seconda chiamata sovrascrive la prima)
\newcommand{\extractcoordpaircolonbis}[3]{
	\def\extractcoordpaircolonabis{}
	\def\extractcoordpaircolonrbis{}
	\extractcoordpaircolonIterFistbis#3:
	\def#1{\extractcoordpaircolonabis}
	\def#2{\extractcoordpaircolonrbis}
}
\newcommand{\extractcoordpaircolonIterFistbis}[1]{
	\ifx:#1 
		\expandafter\extractcoordpaircolonIterSecondbis
	\else 
		\estendistr\extractcoordpaircolonabis{#1}
		\expandafter\extractcoordpaircolonIterFistbis
	\fi
}
\newcommand{\extractcoordpaircolonIterSecondbis}[1]{
	\ifx:#1 \else
		\estendistr\extractcoordpaircolonrbis{#1}
		\expandafter\extractcoordpaircolonIterSecondbis
	\fi
}
