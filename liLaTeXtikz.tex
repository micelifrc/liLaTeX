...
\newcommand{\distanza}[2]{\tkzCalcLength(#1,#2) \tkzGetLength{distanzaAB} \convertto{cm}{\distanzaAB pt}}

% registra la distanza fra #2 e #3 in #1
\newcommand{\distanzarec}[3]{\tkzCalcLength(#2,#3) \tkzGetLength{distanzarecTemp} \def#1{\convertto{cm}{\distanzarecTemp pt}};}
