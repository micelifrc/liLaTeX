...
\newcommand*{\sistrif}[3][]{
	...
	\ifkeyequal{label}{true}{
		\PRIVstylelbl[PRIVlbl lbl=\kv{lbl x},PRIVlbl col lbl=\kv{col lbl}]{$(sistrifLblXpunta)+(#3-90*\sistrifflipper:\kv{lbl dist})$};
...
\newcommand*{\segmento}[3][]{
	\tikzset{keyfld/.cd,
		...
		lbl/.initial,
		lbl name/.initial = segmentoLabelPos, % il nome da dare alla posizione del label
...
\newcommand*{\PRIVsegmento}[3][]{
	\tikzset{keyfld/.cd,
		...
		PRIV lbl/.initial,
		PRIV lbl name/.initial = segmentoLabelPos, % il nome da dare alla posizione del label
